...
#Barrio
urlpatterns += [
    path('', views.ProductList.as_view(), name='barrio_list'),
    path('ViewBarrio/<int:pk>', views.ProductDetail.as_view(), name='barrio_view'),
    path('NewBarrio', views.ProductCreate.as_view(), name='barrio_new'),
    path('EditBarrio/<int:pk>', views.ProductUpdate.as_view(), name='barrio_edit'),
    path('DeleteBarrio/<int:pk>', views.ProductDelete.as_view(), name='barrio_delete'),
]
